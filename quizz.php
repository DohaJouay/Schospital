		...
		<table id="example" class="table table-bordered">
			...
			<tbody>
				...
				foreach ($cur as $result) {
					...
					echo '<td><a href="index.php?q=viewpdff&id='.$result->QuizzID.'" class="btn btn-xs btn-info"><i class="fa fa-info"></i> View File</a>
					      <a title="Upload File" href="index.php?q=uploadfile&id='.$result->QuizzID.'"  class="btn btn-primary btn-xs  ">  <span class="fa fa-upload fw-fa"></span>Déposer Travail</a> 	
					      </td>';	
					echo '</tr>'; 
				}
				?>
