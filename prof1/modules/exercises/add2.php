...
$res = $exercise->single_correction($id);

                       ?> 
 <form class="form-horizontal span6" action="controller.php?action=add1" method="POST" enctype="multipart/form-data">
 <style>
  .col-lg-12{
    margin-left:150px;
    margin-top:50px
  ...
  .save{
    margin-left:400px;
           ...
           <div class="row">
         <div class="col-lg-12">
            <h1 class="page-header">Déposer Correction</h1>
          </div>
          <!-- /.col-lg-12 -->
       </div> 
            <!--
