...
?> 
 ...
 <form class="form-horizontal span6" action="controller.php?action=updatefiles2" method="POST" enctype="multipart/form-data">

           <div class="row">
         <div class="col-lg-12">
            <h1 class="page-header">Déposer la réponse du quizz</h1>
          </div>
          <!-- /.col-lg-12 -->
       </div> 
